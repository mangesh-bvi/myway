                       ...
                       <div className="login-input-cntr">
                          <div className="row">
                               <div className="login-fields col-md-4">
                                    ...
                                    />
                                    <span style={{color: "red"}}>{this.state.errors["ContainerNo"]}</span>
                               </div>
                               <div className="login-fields col-md-4">
                                    <label>Status</label>
                                    <select
                          ...
                          <div className="row">
                               <div className="login-fields col-md-4">
                                    ...
                                    />
                                    <span style={{color: "red"}}>{this.state.errors["DiffInDays"]}</span>
                               </div>
                               <div className="login-fields col-md-4">
                                    <label>PTTP</label>
                                    <input
                                        ...
                                        //onBlur={this.handleBlurUser.bind(this, "username")}
                                    />
                                    <span style={{color: "red"}}>{this.state.errors["PTTP"]}</span>
                               </div>
                          </div>
                          <div className="row">
                               <div className="login-fields col-md-4">
